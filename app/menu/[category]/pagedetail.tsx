...
export default function CategoryPage() {
  ...
  return (
    <div className={`min-h-screen bg-[#f5f0eb] pb-8 ${poppins.className}`}>
      ...
      {/* Modal Overlay - Tanpa background hitam, dengan efek blur */}
      {expandedCard && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Content */}
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative z-10">
            <div className="p-6">
              {/* Header dalam modal */}
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className={`text-xl sm:text-2xl font-semibold mt-2 ${categoryInfo.priceColor}`}>
                    {currentProduct.price}
                  </p>
                </div>
                <button 
              ...
              {/* Video YouTube */}
              <div className="mb-8">
                <h4 className="text-lg font-bold text-gray-900 mb-4">Video Resep</h4>
              ...
              {/* Komposisi */}
              <div className="mb-8">
                <h4 className="text-lg font-bold text-gray-900 mb-4">Komposisi</h4>
              ...
              {/* Informasi Nutrisi */}
              <div className="mb-8">
                <h4 className="text-lg font-bold text-gray-900 mb-4">Informasi Nutrisi</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center bg-gray-50 rounded-xl p-4">
                    <p className="text-xl font-bold text-gray-900">{currentProduct.nutrition.calories}</p>
                    <p className="text-sm text-gray-600">Kalori</p>
                  </div>
                  <div className="text-center bg-gray-50 rounded-xl p-4">
                    <p className="text-xl font-bold text-gray-900">{currentProduct.nutrition.protein}</p>
                    <p className="text-sm text-gray-600">Protein</p>
                  </div>
                  <div className="text-center bg-gray-50 rounded-xl p-4">
                    <p className="text-xl font-bold text-gray-900">{currentProduct.nutrition.carbs}</p>
                    <p className="text-sm text-gray-600">Karbohidrat</p>
                  </div>
                  <div className="text-center bg-gray-50 rounded-xl p-4">
                    <p className="text-xl font-bold text-gray-900">{currentProduct.nutrition.fat}</p>
